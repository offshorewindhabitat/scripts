...
con_sq <- default_db("sqlite") # /Users/bbest/Library/Application Support/aquamaps/am.db
dbListTables(con)
```
...
ply_hcaf_brgn <- st_intersection(ply_hcaf, ply_brgn)
...
system.time({
c_spp <- tbl(con, "hcaf_species_native") %>% 
  filter(
    CenterLong  > x1,
    CenterLong  < x2,
    CenterLat   > y1,
...
ply_hcaf_brgn <- ply_hcaf_brgn %>% 
  left_join(
    c_spp,
    by = "CsquareCode")
mapview(ply_hcaf_brgn, zcol="n_spp")
