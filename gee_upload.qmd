...
* [TensorFlow for R – gcloud\_install](https://tensorflow.rstudio.com/reference/cloudml/gcloud_install) (source: [gcloud-install.R](https://github.com/rstudio/cloudml/blob/main/R/gcloud-install.R))
