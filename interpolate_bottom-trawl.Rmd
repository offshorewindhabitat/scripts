...
<SQLiteConnection>
  Path: /Users/bbest/Library/Application Support/aquamaps/am.db
  Extensions: TRUE
Error in split_lines(text) : 
  lazy-load database '/Library/Frameworks/R.framework/Versions/4.2-arm64/Resources/library/xfun/R/xfun.rdb' is corrupt
In addition: Warning message:
In split_lines(text) : internal error -3 in R_decompress1
Error in split_lines(text) : 
  lazy-load database '/Library/Frameworks/R.framework/Versions/4.2-arm64/Resources/library/xfun/R/xfun.rdb' is corrupt
In addition: Warning messages:
1: In split_lines(text) : restarting interrupted promise evaluation
2: In split_lines(text) : internal error -3 in R_decompress1
```
